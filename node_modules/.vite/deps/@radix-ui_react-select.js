...
import {
  ...
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-JCAQQVTS.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-5TDQL2SL.js";
import {
  require_react_dom
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React21.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React21.useCallback((option) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime7.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime7.jsx)(React21.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectContentFragment = React21.forwardRef((props, forwardedRef) => {
