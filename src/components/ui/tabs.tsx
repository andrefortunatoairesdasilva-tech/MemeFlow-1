...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 p-1 gap-1',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'dark:data-[state=active]:bg-gray-900 dark:data-[state=active]:text-purple-400',
